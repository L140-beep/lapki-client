...
export const ComponentEditModal: React.FC<ComponentEditModalProps> = ({
  ...
  return (
    <Modal
      ...
      title={
        <>
          Редактор компонента: <span className="text-primary">{componentName}</span>
        </>
      }
      ...
      sideClassName="btn h-8 min-w-[74px] border-error bg-error px-3 py-1.5 text-text-secondary enabled:hover:opacity-90 enabled:active:opacity-80"
